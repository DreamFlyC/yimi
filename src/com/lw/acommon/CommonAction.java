...
import com.lw.foodinfotype.action.Json;
...
public class CommonAction {
	...
	@ResponseBody
	public Json loginSuccess(HttpServletResponse response) {
		response.setHeader("Access-Control-Allow-Origin", "*");
		if(type==1) {
			type=0;
			return new Json(true,"success",type);
		}else {
			type=0;
			return new Json(false,"fail",type);
		}
	}
