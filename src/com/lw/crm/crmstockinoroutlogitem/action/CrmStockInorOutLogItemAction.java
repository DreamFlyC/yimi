...
public class CrmStockInorOutLogItemAction extends BaseAction {
	...
	public String ajax() {
		return "/WEB-INF/crmstockinoroutlogitem/ajax";
	}
	...
	public String test(HttpServletRequest request,HttpServletResponse response) {
		...
		response.setHeader("Access-Control-Allow-Origin","http://192.168.1.110:8012");
		//response.setHeader("Access-Control-Allow-Origin","http://192.168.1.120:8012");
