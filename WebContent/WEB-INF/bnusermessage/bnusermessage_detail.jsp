	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnusermessage/post.html" id="userForm">
				<input type="hidden" name="id" value="${bnUserMessage.id }${bnUserMessage.id }">
...
<table class="table table-bordered">
	<tr>
    	...
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="type" value="${bnUserMessage.type }" maxlength="50" placeholder="type" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	<td class="info col-md-1 text-right"><span class="red">*</span>发送者用户名:</td>
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="postusername" value="${bnUserMessage.postusername }" maxlength="50" placeholder="postusername" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	<td class="info col-md-1 text-right"><span class="red">*</span>接收者用户名:</td>
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="acceptusername" value="${bnUserMessage.acceptusername }" maxlength="50" placeholder="acceptusername" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	<td class="info col-md-1 text-right"><span class="red">*</span>已读:</td>
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="isread" value="${bnUserMessage.isread }" maxlength="50" placeholder="isread" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	<td class="info col-md-1 text-right"><span class="red">*</span>标题:</td>
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="title" value="${bnUserMessage.title }" maxlength="50" placeholder="title" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	<td class="info col-md-1 text-right"><span class="red">*</span>内容:</td>
    	<td class="col-md-11">
    		<input type="text" class="form-control" name="content" value="${bnUserMessage.content }" maxlength="50" placeholder="content" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
    	</td>
    </tr>
    <tr>
    	...
    	<input type="text" name="posttime" id="sdate" style="text-align: left;"
			...
			value="<fmt:formatDate value='${bnUserMessage.posttime}' pattern='yyyy-MM-dd HH:mm:ss' />"
    ...
    <tr>
    	...
    	<input type="text" name="readtime" id="sdate" style="text-align: left;"
			...
			value="<fmt:formatDate value='${bnUserMessage.readtime}' pattern='yyyy-MM-dd HH:mm:ss' />"
			onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" onchange=""
			class="form-control" required />
    	</td>
    </tr>
