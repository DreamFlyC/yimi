	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnuserloginlog/post.html" id="userForm">
				<input type="hidden" name="id" value="${bnUserLoginLog.id}">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						 <tr>
					    	...
					    	<td class="col-md-11">
					    		<input type="text" class="form-control" name="userid" value="${bnUserLoginLog.userid}" maxlength="50" placeholder="userid" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
					    	</td>
					    </tr>
					    <tr>
					    	<td class="info col-md-1 text-right"><span class="red">*</span>用户名:</td>
					    	<td class="col-md-11">
					    		<input type="text" class="form-control" name="username" value="${bnUserLoginLog.username}" maxlength="50" placeholder="username" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
					    	</td>
					    </tr>
						<tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>备注:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="remark" value="${bnUserLoginLog.remark}" maxlength="50" placeholder="remark" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	...
						    	<input type="text" name="logintime" id="logintime" style="text-align: left;"
									...
									value="<fmt:formatDate value='${bnUserLoginLog.logintime}' pattern='yyyy-MM-dd HH:mm:ss' />"
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="loginip" value="${bnUserLoginLog.loginip}" maxlength="50" placeholder="loginip" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
