...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnmanagerlog/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="user_id" value="" maxlength="50" placeholder="user_id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>用户名:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="user_name" value="" maxlength="50" placeholder="user_name" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="note" value="" maxlength="50" placeholder="备注" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>登录ip:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="login_ip" value="" maxlength="50" placeholder="login_ip" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
