...
<head>
    ...
    <title>${appName}_供应商商品报价表管理</title>
...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="<%=basePath%>manage/crmsupplierprice/crmsupplierprice_list.html">供应商商品报价列表</a></li>
        <li>修改供应商商品报价信息</li>
    </ul>
</div>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="snumber" id="snumber" required value="${crmSupplierPrice.snumber}"
                                   maxlength="50" placeholder="请输入商品编号" autocomplete="off" datatype="*1-50"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="name" id="name" required value="${crmSupplierPrice.name}"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="price" id="price" required value="${crmSupplierPrice.price}"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="unit" class="form-control" required datatype="select">
                                <option value="${crmSupplierPrice.unit}">${crmSupplierPrice.unit==null?"无":crmSupplierPrice.unit}</option>
                                <!--动态从数据库查数据并组合成option  -->
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="type" class="form-control" required datatype="select">
                                <option value="${crmSupplierPrice.type}" selected="selected">${crmSupplierPrice.crmName.name}</option>
                                <!--动态从数据库查数据并组合成option  -->
                    ...
                    <tr>
                        <td class="info col-md-1 text-right">seq:</td>
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="seq" id="seq" value="${crmSupplierPrice.seq}"
                                   maxlength="50" placeholder="seq" autocomplete="off" datatype="*1-50"
                                   errormsg="至少1个字符,最多50个字符！">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="sid" class="form-control" required datatype="select">
                                <option value="${crmSupplierPrice.sid}" selected="selected">${crmSupplierPrice.crmSupplier.supplier}</option>
