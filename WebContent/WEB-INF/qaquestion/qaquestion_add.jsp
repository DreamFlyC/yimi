...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/qaquestion/post.html" id="userForm">
						...
						<table class="table table-bordered">
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="qtype" value="" maxlength="50" placeholder="问题类型" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>seq:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="seq" value="" maxlength="50" placeholder="seq" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>内容:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="content" value="" maxlength="50" placeholder="内容" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>备注:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="remark" value="" maxlength="50" placeholder="备注" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>oid:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="oid" value="" maxlength="50" placeholder="oid" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
					    </table>    			
