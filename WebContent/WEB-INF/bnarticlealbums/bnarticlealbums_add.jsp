...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			...
			action="<%=basePath%>manage/bnarticlealbums/post.html" id="userForm">
				<div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse" data-parent="#accordion" href="#panelInfo">添加相册图片信息</div>				
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						 	<tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name=articleid value="" maxlength="50" nullmsg="articleID" placeholder="articleID" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						   <tr>
						...
						<tr>
					     ...
					     <tr>
					    	...
					    	<td class="col-md-11">
					    		<input type="number" class="form-control" name="remark" value="" maxlength="50"  placeholder="uid" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
					    	</td>
					    </tr>
