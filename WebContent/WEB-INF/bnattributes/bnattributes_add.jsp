...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnattributes/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="channelid" value="" maxlength="50" placeholder="channelid" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    ...
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="defaultvalue" value="" maxlength="50" placeholder="默认值" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>sort_id:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="sortid" value="" maxlength="50" placeholder="sort_id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
					    </table>    			
