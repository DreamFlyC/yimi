...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnmanager/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="role_type" value="" maxlength="50" placeholder="role_type" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="user_pwd" value="" maxlength="50" placeholder="user_pwd" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>真实名:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="real_name" value="" maxlength="50" placeholder="real_name" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>电话号码:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="telephone" value="" maxlength="50" placeholder="telephone" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
