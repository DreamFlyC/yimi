...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/foodinfotype/post.html" id="userForm">
				<input type="hidden" name="parent_id" value="${foodInfoType.id}">
				...
				<div id="panelInfo" class="panel-collapse collapse in">
         			<div class="panel-body">
						<table class="table table-bordered">
							<tr>
						    	<td class="info col-md-1 text-right">父类:</td>
						    	<td class="col-md-11">
						    	<label class="form-control">${foodInfoType.name}</label>
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right">parent_id:</td>
						    	<td class="col-md-11">
                      				<label class="form-control">${foodInfoType.id}</label>
						    	</td>
						    </tr>
							<tr>
