		...
		<%@ include file="../top.jsp"%>
   		...
   		<div class="place">
    		...
    		<ul class="placeul">
				...
				<li><a href="<%=basePath%>manage/restaurantsoftinfo/post.html">添加软件信息日志</a></li>
    		</ul>
    	</div>
		<div class="rightContainer">
        </script>
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/restaurantsoftinfo/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="authorkey" value="" 
						    ...
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="lastloginip" value="" 
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="upinfo" value="" 
