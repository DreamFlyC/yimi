...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bndistribution/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="number" step="0.01" class="form-control" name="amount" value="" maxlength="50" placeholder="amount" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>sort_id:</td>
						    	<td class="col-md-11">
						    		<input type="number" step="1" class="form-control" name="sort_id" value="" maxlength="50" placeholder="sort_id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
