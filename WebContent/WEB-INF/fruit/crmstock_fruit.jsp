...
<body>
    <div style="width: 50%;margin: 100px auto;">
		<div class="container-fluid">
	        <form id="form" action="/manage/fruit/saveupload" method="post" enctype="multipart/form-data">
   		...
   		<%-- <div style="width:50px;height: 50px;margin: 0px auto;border:1px solid red;text-align: center;position:relative;top:50%;"><img alt="loading" src="<%=basePath%>resources/adpic/img/loading.gif" style="width:100%;"></div>
    --%> <script>
	    $(function () {
	    ...
	    function initFileInput(ctrlName) {
	        ...
	        control.fileinput({
	            language: 'zh', //设置语言
	            uploadUrl: "fruit/saveupload", //上传的地址
	        	...
	        	window.location.href="fruit/show?fileName="+fileName;
