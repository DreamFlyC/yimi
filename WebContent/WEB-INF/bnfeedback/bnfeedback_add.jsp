...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bnfeedback/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="content" value="" maxlength="50" placeholder="留言内容" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    ...
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="user_qq" value="" maxlength="50" placeholder="QQ" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>邮箱:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="user_email" value="" maxlength="50" placeholder="email" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>回应内容:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="reply_content" value="" maxlength="50" placeholder="回应内容" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	...
						    	<input type="text" name="reply_time" id="reply_time" style="text-align: left;"
									placeholder="回应时间" autocomplete="off"
