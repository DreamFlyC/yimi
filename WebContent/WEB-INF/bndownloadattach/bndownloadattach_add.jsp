...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/bndownloadattach/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
						    <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="article_id" value="" maxlength="50" placeholder="article_id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="file_path" value="" maxlength="50" placeholder="文件路径" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>文件后缀名:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="file_ext" value="" maxlength="50" placeholder="文件后缀名" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>文件大小:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="file_size" value="" maxlength="50" placeholder="文件大小" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>下载次数:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="down_num" value="" maxlength="50" placeholder="下载次数" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>点评:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="point" value="" maxlength="50" placeholder="点评" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
					    </table>    			
